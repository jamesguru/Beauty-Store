import { FaCheckCircle, FaShoppingBag, FaTruck, FaCreditCard, FaStar } from 'react-icons/fa';
              ...
              <div key={order._id} className="bg-white rounded-2xl shadow-lg overflow-hidden">
                ...
                <div className="bg-rose-50 p-6 border-b border-rose-100">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                    ...
                    <span className="bg-rose-100 text-rose-700 px-3 py-1 rounded-full text-sm font-medium mt-2 sm:mt-0">
                      ...
                      <div key={productIndex} className="border-b border-gray-100 pb-6 last:border-0">
                        <div className="flex flex-col sm:flex-row items-start gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-lg font-bold text-rose-700 mt-1">${(product.price * product.quantity).toFixed(2)}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <div className="flex justify-between mb-2 pt-2 border-t border-gray-100">
                        ...
                        <span className="text-lg font-semibold text-rose-700">${(calculateOrderTotal(order) + 10).toFixed(2)}</span>
                      </div>
                    </div>
                  </div>
                </div>
